function [f_audio,sideinfo] = waveform_to_audio(f_audio,fs,nbits,parameter)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Name: wav_to_audio
...
if nargin<3
    error('Please specify the waveform, sampling rate, and nbits')
end
...
sideinfo.wav.duration   = (sideinfo.wav.size-1)/parameter.destSamplerate;
sideinfo.wav.energy     = sum(f_audio.^2);
sideinfo.wav.fs         = parameter.destSamplerate;
sideinfo.wav.sourceFs   = fs;
